...
package gradle.kotlin.dsl.plugins._2c254f0bff1c006b015dbf8acac33b0b
...
/**
 * The `io.spring` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoSpringPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.spring`.
 */
internal
val `IoPluginGroup`.`spring`: `IoSpringPluginGroup`
    get() = `IoSpringPluginGroup`(plugins)


/**
 * The `io.spring.dependency-management` plugin implemented by [io.spring.gradle.dependencymanagement.DependencyManagementPlugin].
 */
internal
val `IoSpringPluginGroup`.`dependency-management`: PluginDependencySpec
    get() = plugins.id("io.spring.dependency-management")
...
/**
 * The `org.springframework` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgSpringframeworkPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.springframework`.
 */
internal
val `OrgPluginGroup`.`springframework`: `OrgSpringframeworkPluginGroup`
    get() = `OrgSpringframeworkPluginGroup`(plugins)


/**
 * The `org.springframework.boot` plugin implemented by [org.springframework.boot.gradle.plugin.SpringBootPlugin].
 */
internal
val `OrgSpringframeworkPluginGroup`.`boot`: PluginDependencySpec
    get() = plugins.id("org.springframework.boot")
